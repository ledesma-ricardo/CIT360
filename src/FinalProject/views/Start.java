...
public class Start extends javax.swing.JFrame {
    ...
    public void verifypassword() {
        ...
        if (CONNECTION.VerifyLogin("from Users where usuario = '" + usuario + "' and password = '" + password + "'")) {
            this.dispose();
    ...
    private void initComponents() {
        ...
        txtuser.setForeground(new java.awt.Color(102, 0, 204));
        ...
        btnSesion.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        btnSesion.setForeground(new java.awt.Color(0, 51, 102));
        btnSesion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login.png"))); // NOI18N
        btnSesion.setText("Log In");
    ...
    private void btnSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSesionActionPerformed
        // Verifica la contraseña & Password del Usuario ...:
        verifypassword();
